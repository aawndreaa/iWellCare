...
@section('title', 'My Consultations - iWellCare')
@section('page-title', 'My Consultations')
@section('page-subtitle', 'View your consultation history and medical records')
        ...
        <div class="card p-6" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-bold">{{ $consultations->count() }}</p>
                </div>
        ...
        <div class="card p-6" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-bold">{{ $consultations->where('consultation_date', '>=', now()->startOfMonth())->count() }}</p>
                </div>
                <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
        ...
        <div class="card p-6" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-lg font-bold">{{ $consultations->first() ? \Carbon\Carbon::parse($consultations->first()->consultation_date)->format('M d, Y') : 'None' }}</p>
                </div>
                <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('patient.consultations.show', $consultation) }}" class="btn-primary text-sm">
