    ...
    <div class="max-w-7xl mx-auto">
        ...
        <form action="{{ route('admin.invoice.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="patient_id" class="form-input w-full pl-10 pr-4 py-2.5 bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 @error('patient_id') border-red-500 ring-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="appointment_id" class="form-input w-full pl-10 pr-4 py-2.5 bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 @error('appointment_id') border-red-500 ring-red-500 @enderror">
                ...
                <div class="xl:sticky xl:top-6 h-fit">
                    ...
                    <div class="bg-white rounded-lg p-4 border-2 border-gray-200 shadow-inner max-h-[600px] overflow-y-auto">
                        <div class="text-center mb-4" style="font-family: Arial, sans-serif; font-size: 11px; line-height: 1.2;">
                            ...
                            <p style="margin: 2px 0;"><strong>No.</strong> <span id="preview-invoice-no">{{ 'INV-' . date('Y') . '-0001' }}</span> &nbsp;&nbsp;&nbsp; <strong>Date:</strong> <span id="preview-date">{{ date('M d, Y') }}</span></p>
                        </div>
                        ...
                        <div style="text-align: right; margin-top: 15px; font-size: 10px;">
                            ...
                            <em id="representative-name">
                                @if(isset($defaultDoctor) && $defaultDoctor && $defaultDoctor->user)
                                    Dr. {{ $defaultDoctor->user->first_name ?? '' }} {{ $defaultDoctor->user->last_name ?? '' }}
                                @else
            ...
            <div class="bg-white rounded-xl p-5 md:p-6 border border-gray-200 shadow-lg">
                <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">Enter fee amounts and payment details</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="consultation_fee" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('consultation_fee') border-red-500 ring-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="medication_fee" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('medication_fee') border-red-500 ring-red-500 @enderror"
                                       min="0" step="0.01" value="{{ old('medication_fee') }}" placeholder="0.00">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="laboratory_fee" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('laboratory_fee') border-red-500 ring-red-500 @enderror"
                                       min="0" step="0.01" value="{{ old('laboratory_fee') }}" placeholder="0.00">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="other_fees" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('other_fees') border-red-500 ring-red-500 @enderror"
                                       min="0" step="0.01" value="{{ old('other_fees') }}" placeholder="0.00">
                            </div>
                            @error('other_fees')
                                <p class="text-red-500 text-xs mt-1 flex items-center gap-1">
                                    <i class="fas fa-exclamation-circle"></i>{{ $message }}
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="discount_percentage" id="discount_percentage" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('discount_percentage') border-red-500 ring-red-500 @enderror"
                                       min="0" max="100" step="0.01" value="{{ old('discount_percentage') }}" placeholder="0.00">
                            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="status" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('status') border-red-500 ring-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="payment_date" class="form-input w-full pl-10 pr-4 py-2.5 bg-gray-50 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white transition-all duration-200 @error('payment_date') border-red-500 ring-red-500 @enderror"
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-4 mt-6 pt-6 border-t-2 border-gray-200">
                <a href="{{ route('admin.invoice.index') }}" class="inline-flex items-center justify-center px-6 py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm hover:shadow-md order-2 sm:order-1">
