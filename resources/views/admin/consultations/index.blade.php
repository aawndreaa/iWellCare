                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <a href="{{ route('admin.consultations.create', ['patient_id' => $consultation->patient->id]) }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="{{ route('admin.consultations.physical-exam', $consultation) }}"
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="text-gray-500">
                                            ...
                                            <a href="{{ route('admin.consultations.create') }}" class="btn btn-primary inline-flex items-center">
