            ...
            <div class="card p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span class="text-gray-800">{{ $patient->date_of_birth ? \Carbon\Carbon::parse($patient->date_of_birth)->format('M d, Y') : 'N/A' }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('admin.consultations.create', ['patient_id' => $patient->id]) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                        New Consultation
                    </a>
                </div>
