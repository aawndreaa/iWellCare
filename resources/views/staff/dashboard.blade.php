...
@section('title', 'Staff Dashboard - iWellCare')
@section('page-title', 'Staff Dashboard')
@section('page-subtitle', 'Welcome back, ' . (auth()->user()->first_name ?? 'Staff') . '!')
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-bold">{{ $todaysAppointments ?? 0 }}</p>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-bold">{{ $pendingConfirmations ?? 0 }}</p>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-bold">{{ $lowInventory ?? 0 }}</p>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-bold">{{ $unpaidBills ?? 0 }}</p>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <!-- Manage Appointments -->
                <a href="{{ route('staff.appointments.index') }}" class="group relative overflow-hidden p-5 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-gradient-to-br hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                ...
                <!-- Patient Management -->
                <a href="{{ route('staff.patients.index') }}" class="group relative overflow-hidden p-5 border border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-br hover:from-green-50 hover:to-emerald-50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                    <div class="flex flex-col items-center text-center">
                ...
                <!-- Create Invoice -->
                <a href="{{ route('staff.billing.create') }}" class="group relative overflow-hidden p-5 border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-gradient-to-br hover:from-purple-50 hover:to-violet-50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                    <div class="flex flex-col items-center text-center">
                ...
                <!-- Inventory -->
                <a href="{{ route('staff.inventory.index') }}" class="group relative overflow-hidden p-5 border border-gray-200 rounded-xl hover:border-orange-300 hover:bg-gradient-to-br hover:from-orange-50 hover:to-amber-50 transition-all duration-300 hover:shadow-lg hover:scale-105">
                    <div class="flex flex-col items-center text-center">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('staff.appointments.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-semibold hover:underline transition-colors">View All</a>
            </div>
        </div>
                    ...
                    <div class="group p-4 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-800">{{ $appointment->patient ? $appointment->patient->first_name . ' ' . $appointment->patient->last_name : 'Unknown Patient' }}</div>
                                    <div class="text-sm text-gray-600">{{ $appointment->doctor ? $appointment->doctor->first_name . ' ' . $appointment->doctor->last_name : 'Unknown Doctor' }} • {{ \Carbon\Carbon::parse($appointment->appointment_date)->format('M d, Y') }}</div>
                                </div>
                            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('staff.patients.index') }}" class="text-green-600 hover:text-green-700 text-sm font-semibold hover:underline transition-colors">View All</a>
            </div>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="group p-4 border border-gray-200 rounded-xl hover:border-green-300 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-300">
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('staff.patients.show', $patient) }}" class="w-8 h-8 bg-green-100 hover:bg-green-200 rounded-lg flex items-center justify-center text-green-600 hover:text-green-700 transition-colors">
