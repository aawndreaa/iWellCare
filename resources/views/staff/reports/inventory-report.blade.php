    ...
    <div class="p-6">
        <form method="GET" action="{{ route('staff.reports.inventory') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('staff.reports.inventory') }}" class="btn-secondary">Clear</a>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="table-header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('staff.reports.inventory', array_merge(request()->all(), ['print' => 1])) }}" target="_blank" class="btn-secondary">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-700">
                        ...
                        @if($item->updatedBy)
                            <div class="text-xs text-gray-500">by {{ $item->updatedBy->first_name ?? '' }} {{ $item->updatedBy->last_name ?? '' }}</div>
                        @endif
                    </td>
                </tr>
                @empty
...
<!-- Export Forms -->
<form id="pdfExportForm" action="{{ route('staff.reports.export') }}" method="POST" style="display: none;">
    @csrf
