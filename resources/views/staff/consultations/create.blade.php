...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('staff.consultations.index') }}" class="btn btn-secondary">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <form action="{{ route('staff.consultations.store') }}" method="POST" id="consultationForm">
            @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function populatePatientData(patient) {
        if (patient.medical_history) {
            document.getElementById('past_medical_history').value = patient.medical_history;
        }
        if (patient.current_medications) {
            document.getElementById('medications').value = patient.current_medications;
        }
