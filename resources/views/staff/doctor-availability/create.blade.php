...
@section('title', 'Set Doctor Availability - iWellCare')
@section('page-title', 'Set Doctor Availability')
@section('page-subtitle', 'Set doctor availability for appointments')
...
<div class="doctor-availability-content">
    ...
    <div class="card p-6 max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <form action="{{ route('staff.doctor-availability.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="doctor_id" id="doctor_id" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" required>
                            ...
                            @foreach($doctors as $doctor)
                                <option value="{{ $doctor->id }}" {{ old('doctor_id') == $doctor->id ? 'selected' : (!old('doctor_id') && $loop->first ? 'selected' : '') }}>
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="3"
                                  ...
                                  placeholder="Any additional notes about availability...">{{ old('notes') }}</textarea>
                    </div>
                </div>
        ...
        <div class="border-t border-gray-200 pt-8">
            ...
            <form action="{{ route('staff.doctor-availability.bulk-update') }}" method="POST" id="bulkForm">
                @csrf
