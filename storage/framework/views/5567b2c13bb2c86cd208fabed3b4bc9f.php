...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Adult Wellness Clinic'); ?></title>
...
<body class="antialiased flex flex-col min-h-screen">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <a href="<?php echo e(route('home')); ?>" class="navbar-brand">
                        <img src="<?php echo e(asset('assets/img/iWellCare-logo.png')); ?>" alt="iWellCare Logo" class="h-8 md:h-12 w-auto mr-2 md:mr-3">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2">
                                ...
                                <?php if(Auth::user()->role === 'doctor'): ?>
                                    <a href="<?php echo e(route('doctor.profile.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                        <i class="fas fa-user-cog mr-2"></i>Profile
                                    </a>
                                <?php elseif(Auth::user()->role === 'staff'): ?>
                                    <a href="<?php echo e(route('staff.profile.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                        <i class="fas fa-user-cog mr-2"></i>Profile
                                    </a>
                                <?php elseif(Auth::user()->role === 'patient'): ?>
                                    <a href="<?php echo e(route('patient.profile.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                        <i class="fas fa-user-cog mr-2"></i>Profile
                                    </a>
                                <?php endif; ?>
            ...
            <div x-show="mobileMenuOpen" x-transition class="md:hidden mt-4 pb-4 border-t border-gray-200">
                <?php if(auth()->guard()->guest()): ?>
                    <div class="flex flex-col space-y-2">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary w-full justify-center">
                            <i class="fas fa-sign-in-alt mr-2"></i>Login
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline w-full justify-center">
                            <i class="fas fa-user-plus mr-2"></i>Register
                        </a>
                    </div>
                <?php else: ?>
                    <div class="flex flex-col space-y-2">
                        ...
                        <?php if(Auth::user()->role === 'doctor'): ?>
                            <a href="<?php echo e(route('doctor.profile.index')); ?>" class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                <i class="fas fa-user-cog mr-2"></i>Profile
                            </a>
                        <?php elseif(Auth::user()->role === 'staff'): ?>
                            <a href="<?php echo e(route('staff.profile.index')); ?>" class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                <i class="fas fa-user-cog mr-2"></i>Profile
                            </a>
                        <?php elseif(Auth::user()->role === 'patient'): ?>
                            <a href="<?php echo e(route('patient.profile.index')); ?>" class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                <i class="fas fa-user-cog mr-2"></i>Profile
                            </a>
                        <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-600 text-sm mb-2 md:mb-0">
                    &copy; <?php echo e(date('Y')); ?> Adult Wellness Clinic and Medical Laboratory. All rights reserved.
                </p>
                <div class="flex space-x-6 text-sm">
                    <a href="<?php echo e(route('privacy-policy')); ?>" class="text-gray-600 hover:text-blue-600 transition-colors">Privacy Policy</a>
                    <a href="<?php echo e(route('terms-of-service')); ?>" class="text-gray-600 hover:text-blue-600 transition-colors">Terms of Service</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="<?php echo e(asset('assets/js/real-time-service.js')); ?>"></script>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/layouts/app.blade.php ENDPATH**/ ?>