...
<?php $__env->startSection('title', 'Book Appointment - iWellCare'); ?>
<?php $__env->startSection('page-title', 'Book New Appointment'); ?>
<?php $__env->startSection('page-subtitle', 'Schedule an appointment with a doctor'); ?>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('patient.appointments.index')); ?>" class="text-sm font-medium text-gray-700 hover:text-blue-600">Appointments</a>
                    </div>
                </li>
                    ...
                    <select name="doctor_id" id="doctor_id" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base md:text-lg transition-colors" required>
                        ...
                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($doctor->id); ?>"
                                <?php echo e(old('doctor_id', $defaultDoctor ? $defaultDoctor->id : '') == $doctor->id ? 'selected' : ''); ?>

                                class="<?php if(!$doctor->current_availability['is_available']): ?> text-red-500 <?php else: ?> text-gray-900 <?php endif; ?>"
                            >
                                Dr. <?php echo e($doctor->user->first_name); ?> <?php echo e($doctor->user->last_name); ?> - <?php echo e($doctor->specialization); ?>

                                <?php if($doctor->current_availability['is_available']): ?>
                                    ✅ Available
                                <?php else: ?>
                                    ❌ <?php echo e($doctor->current_availability['message']); ?>

                                <?php endif; ?>
                                <?php if($defaultDoctor && $doctor->id == $defaultDoctor->id): ?>
                                    (Default)
                                <?php endif; ?>
                            </option>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 md:p-6">
                        ...
                        <select name="type" id="type" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base md:text-lg transition-colors" required>
                            ...
                            <option value="checkup" <?php echo e(old('type') == 'checkup' ? 'selected' : ''); ?>>Regular Checkup</option>
                            ...
                            <option value="follow-up" <?php echo e(old('type') == 'follow-up' ? 'selected' : ''); ?>>Follow-up</option>
                        </select>
                ...
                <div class="bg-gray-50 rounded-xl p-4 md:p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        <select name="appointment_time" id="appointment_time" class="col-span-2 md:col-span-3 lg:col-span-4 px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base md:text-lg transition-colors" required>
                            ...
                            <option value="09:00:00" <?php echo e(old('appointment_time') == '09:00:00' ? 'selected' : ''); ?>>9:00 AM</option>
                            <option value="09:30:00" <?php echo e(old('appointment_time') == '09:30:00' ? 'selected' : ''); ?>>9:30 AM</option>
                            <option value="10:00:00" <?php echo e(old('appointment_time') == '10:00:00' ? 'selected' : ''); ?>>10:00 AM</option>
                            <option value="10:30:00" <?php echo e(old('appointment_time') == '10:30:00' ? 'selected' : ''); ?>>10:30 AM</option>
                            <option value="11:00:00" <?php echo e(old('appointment_time') == '11:00:00' ? 'selected' : ''); ?>>11:00 AM</option>
                            <option value="11:30:00" <?php echo e(old('appointment_time') == '11:30:00' ? 'selected' : ''); ?>>11:30 AM</option>
                            <option value="14:00:00" <?php echo e(old('appointment_time') == '14:00:00' ? 'selected' : ''); ?>>2:00 PM</option>
                            <option value="14:30:00" <?php echo e(old('appointment_time') == '14:30:00' ? 'selected' : ''); ?>>2:30 PM</option>
                            <option value="15:00:00" <?php echo e(old('appointment_time') == '15:00:00' ? 'selected' : ''); ?>>3:00 PM</option>
                            <option value="15:30:00" <?php echo e(old('appointment_time') == '15:30:00' ? 'selected' : ''); ?>>3:30 PM</option>
                            <option value="16:00:00" <?php echo e(old('appointment_time') == '16:00:00' ? 'selected' : ''); ?>>4:00 PM</option>
                            <option value="16:30:00" <?php echo e(old('appointment_time') == '16:30:00' ? 'selected' : ''); ?>>4:30 PM</option>
                        </select>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 rounded-xl p-4 md:p-6">
                    ...
                    <textarea name="notes" id="notes" rows="6"
                              ...
                              class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base md:text-lg resize-none transition-colors"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('patient.appointments.index')); ?>" class="btn btn-secondary flex-1 text-base md:text-lg py-4 px-8 rounded-xl transition-all duration-200">
...
<?php echo $__env->make('layouts.patient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/patient/appointments/create.blade.php ENDPATH**/ ?>