...
<?php $__env->startSection('page-subtitle', 'View consultation information'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('admin.consultations.edit', $consultation)); ?>" class="btn btn-secondary">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('admin.appointments.index')); ?>?patient_id=<?php echo e($patient->id); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                        View All
                    </a>
                </div>
            ...
            <div class="card p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('admin.consultations.create', ['patient_id' => $patient->id])); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                        New Consultation
                    </a>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/admin/consultations/show.blade.php ENDPATH**/ ?>