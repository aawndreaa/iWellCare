...
<body>
    ...
    <div class="section">
        ...
        <div style="margin: 20px 0;">
            <div style="margin-bottom: 10px;">
                <strong>Completion Rate:</strong> <?php echo e($completionRate); ?>% (<?php echo e($completed); ?> of <?php echo e($total); ?>)
            </div>
            <div style="margin-bottom: 10px;">
                <strong>In Progress Rate:</strong> <?php echo e($inProgressRate); ?>% (<?php echo e($inProgress); ?> of <?php echo e($total); ?>)
            </div>
        </div>
    </div>
    ...
    <!-- Consultations List -->
    <div class="section">
        <h2>Consultations List (<?php echo e($consultations->count()); ?> total)</h2>
        <?php if($consultations->count() > 0): ?>
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong><?php echo e($consultation->consultation_date->format('M d, Y')); ?></strong><br>
                            <small class="text-muted"><?php echo e($consultation->consultation_date->format('g:i A')); ?></small>
                        </td>
                        <td>
                            <strong><?php echo e($consultation->patient->first_name); ?> <?php echo e($consultation->patient->last_name); ?></strong><br>
                            <small class="text-muted">ID: #<?php echo e($consultation->patient->id); ?></small>
                        </td>
                        <td>
                            <strong><?php echo e($consultation->doctor->first_name ?? 'N/A'); ?></strong><br>
                            <small class="text-muted"><?php echo e($consultation->doctor->role ?? 'N/A'); ?></small>
                        </td>
                        <td>
                        ...
                        <td class="text-center">
                            <?php if($consultationStats['average_duration']): ?>
...
</html> <?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/doctor/reports/pdf/consultation.blade.php ENDPATH**/ ?>