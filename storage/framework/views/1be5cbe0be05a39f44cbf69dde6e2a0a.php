    ...
    <div class="sidebar">
        ...
        <div class="p-4" style="flex: 1 1 auto;">
            <nav class="space-y-2" style="height: 100%;">
                ...
                <a href="<?php echo e(route('admin.prescriptions.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.prescriptions.*') ? 'active' : ''); ?> flex items-center space-x-3 px-4 py-3 text-blue-100 hover:text-white">
