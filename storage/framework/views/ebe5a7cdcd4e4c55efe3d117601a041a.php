                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900"><?php echo e($staff->total()); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900"><?php echo e($staff->where('is_active', true)->count()); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900"><?php echo e($staff->where('is_active', false)->count()); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900"><?php echo e($staff->where('created_at', '>=', now()->startOfMonth())->count()); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-4 py-5 sm:px-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="?filter=active&t=<?php echo e(time()); ?>" class="px-4 py-2 text-sm font-medium rounded-md <?php echo e(request('filter') === 'active' || !request('filter') ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700'); ?>">
                            Active (<?php echo e($activeCount ?? 0); ?>)
                        </a>
                        <a href="?filter=inactive&t=<?php echo e(time()); ?>" class="px-4 py-2 text-sm font-medium rounded-md <?php echo e(request('filter') === 'inactive' ? 'bg-red-100 text-red-700' : 'text-gray-500 hover:text-gray-700'); ?>">
                            Inactive (<?php echo e($inactiveCount ?? 0); ?>)
                        </a>
                        <a href="?filter=archived&t=<?php echo e(time()); ?>" class="px-4 py-2 text-sm font-medium rounded-md <?php echo e(request('filter') === 'archived' ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:text-gray-700'); ?>">
                            Archived (<?php echo e($archivedCount ?? 0); ?>)
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">
                    <?php if(request('filter') === 'active'): ?>
                        Active Staff Members
                    <?php elseif(request('filter') === 'inactive'): ?>
                        Inactive Staff Members
                    <?php elseif(request('filter') === 'archived'): ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <p class="text-sm text-gray-500"><?php echo e($member->username); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo e(route('admin.staff.show', $member)); ?>" class="text-blue-600 hover:text-blue-900 text-sm font-medium">
                                    View
                                </a>
                                <a href="<?php echo e(route('admin.staff.edit', $member)); ?>" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                                    Edit
                                </a>
                                <form method="POST" action="<?php echo e(route('admin.staff.toggle-status', $member)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
                                    <button type="submit" class="text-<?php echo e($member->is_active ? 'red' : 'green'); ?>-600 hover:text-<?php echo e($member->is_active ? 'red' : 'green'); ?>-900 text-sm font-medium">
                                        <?php echo e($member->is_active ? 'Deactivate' : 'Activate'); ?>

                                    </button>
                                </form>
                                <?php if(request('filter') === 'archived'): ?>
                                    <form method="POST" action="<?php echo e(route('admin.staff.restore', $member)); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route('admin.staff.destroy', $member)); ?>" class="inline delete-form">
                                        <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <a href="<?php echo e(route('admin.staff.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/admin/staff/index.blade.php ENDPATH**/ ?>