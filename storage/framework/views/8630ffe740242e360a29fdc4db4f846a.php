    ...
    <form method="GET" action="" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="patient" class="form-input w-full pl-10 auto-filter" value="<?php echo e(request('patient')); ?>" placeholder="Search patient...">
            </div>
        </div>
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="doctor" class="form-input w-full pl-10 auto-filter" value="<?php echo e(request('doctor')); ?>" placeholder="Search doctor...">
            </div>
        </div>
        <div>
            ...
            <div class="relative">
                ...
                <input type="date" name="date" class="form-input w-full pl-10 auto-filter" value="<?php echo e(request('date')); ?>">
            </div>
        </div>
        <div>
        ...
        <div>
            <label class="flex items-center gap-2">
                <input type="checkbox" name="archived" value="1" <?php echo e(request('archived') ? 'checked' : ''); ?> class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td class="py-4 px-6">
                            <div class="flex flex-wrap gap-2">
                                <?php if(!$appointment->is_archived): ?>
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="/staff/appointments/<?php echo e($appointment->id); ?>/archive" class="inline-block">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
                                ...
                                <?php else: ?>
                                    <form method="POST" action="/staff/appointments/<?php echo e($appointment->id); ?>/unarchive" class="inline-block">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
                                                class="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
