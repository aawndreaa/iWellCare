...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="card p-6 flex flex-col items-center bg-gradient-to-br from-blue-100 to-blue-50 shadow-md">
            ...
            <div class="text-3xl font-bold text-blue-700 mb-2"><?php echo e($patients->total()); ?></div>
        ...
        <div class="card p-6 flex flex-col items-center bg-gradient-to-br from-green-100 to-green-50 shadow-md">
            ...
            <div class="text-3xl font-bold text-green-700 mb-2"><?php echo e($activeCount ?? 0); ?></div>
        ...
        <div class="card p-6 flex flex-col items-center bg-gradient-to-br from-cyan-100 to-cyan-50 shadow-md">
            ...
            <div class="text-3xl font-bold text-cyan-700 mb-2"><?php echo e($newThisMonth ?? 0); ?></div>
        ...
        <div class="card p-6 flex flex-col items-center bg-gradient-to-br from-yellow-100 to-yellow-50 shadow-md">
            ...
            <div class="text-3xl font-bold text-yellow-700 mb-2"><?php echo e($recentAppointments ?? 0); ?></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            ...
            <div>
                ...
                <select id="age_group" name="age_group" class="form-input w-full">
                    ...
                    <option value="child" <?php echo e(request('age_group') === 'child' ? 'selected' : ''); ?>>Child (0-12)</option>
                    <option value="teen" <?php echo e(request('age_group') === 'teen' ? 'selected' : ''); ?>>Teen (13-19)</option>
                    <option value="adult" <?php echo e(request('age_group') === 'adult' ? 'selected' : ''); ?>>Adult (20-64)</option>
                    <option value="senior" <?php echo e(request('age_group') === 'senior' ? 'selected' : ''); ?>>Senior (65+)</option>
                </select>
            </div>
            <div class="flex gap-2">
                <a href="<?php echo e(route('staff.patients.index')); ?>" class="btn btn-secondary flex items-center gap-2">
            ...
            <table class="min-w-full text-sm rounded-lg shadow-lg border border-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        <td class="py-4 px-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="font-medium text-gray-900 truncate"><?php echo e($patient->first_name ?? 'N/A'); ?> <?php echo e($patient->last_name ?? ''); ?></div>
                                    <div class="text-xs text-gray-500 truncate">ID: <?php echo e($patient->id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <div class="space-y-1">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm text-gray-900"><?php echo e($patient->email ?? 'N/A'); ?></span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <i class="fas fa-phone text-gray-400 text-xs"></i>
                                    <span class="text-sm text-gray-900"><?php echo e($patient->contact ?? 'No phone'); ?></span>
                                </div>
                                <?php if($patient->address): ?>
                                <div class="flex items-center gap-2">
                                    <i class="fas fa-map-marker-alt text-gray-400 text-xs"></i>
                                    <span class="text-sm text-gray-900"><?php echo e(Str::limit($patient->address, 30)); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <div class="space-y-1">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($patient->age ?? 'N/A'); ?> years old</div>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                    <?php echo e(ucfirst($patient->gender ?? 'N/A')); ?>

                                </span>
                                <?php if($patient->date_of_birth): ?>
                                <div class="text-xs text-gray-500"><?php echo e($patient->date_of_birth->format('M d, Y')); ?></div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <div class="space-y-1">
                                ...
                                <div class="text-xs text-yellow-600 flex items-center gap-1">
                                    ...
                                    <?php echo e(Str::limit($patient->allergies, 20)); ?>
                                ...
                                <div class="text-xs text-blue-600 flex items-center gap-1">
                                    ...
                                    <?php echo e(Str::limit($patient->medical_history, 20)); ?>
                        ...
                        <td class="py-4 px-6">
                            <?php if($patient->appointments->count() > 0): ?>
                                ...
                                ?>
                                <div class="text-sm font-medium text-gray-900"><?php echo e($lastAppointment->appointment_date->format('M d, Y')); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($lastAppointment->appointment_date->diffForHumans()); ?></div>
                            <?php else: ?>
                        ...
                        <td class="py-4 px-6">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <a href="<?php echo e(route('staff.patients.edit', $patient)); ?>" 
                                ...
                                <a href="<?php echo e(route('staff.consultations.create', ['patient_id' => $patient->id])); ?>" 
                                ...
                                <button type="button" class="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md text-cyan-600 bg-cyan-100 hover:bg-cyan-200 transition-colors duration-200"
                                        onclick="viewHistory(<?php echo e($patient->id); ?>)">
                                ...
                                <button type="button" class="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md text-red-600 bg-red-100 hover:bg-red-200 transition-colors duration-200"
                                        onclick="archivePatient(<?php echo e($patient->id); ?>)">
...
function viewHistory(patientId) {
    ...
    fetch(`/staff/patients/${patientId}/history`)
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/staff/patients/index.blade.php ENDPATH**/ ?>