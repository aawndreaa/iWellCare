...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="<?php echo e(route('staff.inventory.index')); ?>" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 transition-colors">
        ...
        <div class="space-y-6">
            ...
            <form action="<?php echo e(route('staff.inventory.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-gray-50 rounded-xl p-6 flex justify-end gap-4">
                <a href="<?php echo e(route('staff.inventory.index')); ?>" 
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/staff/inventory/create.blade.php ENDPATH**/ ?>