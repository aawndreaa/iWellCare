...
<?php $__env->startSection('title', 'Inventory - iWellCare'); ?>
<?php $__env->startSection('page-title', 'Inventory'); ?>
<?php $__env->startSection('page-subtitle', 'Monitor and update supply levels'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="group relative overflow-hidden rounded-xl p-4 text-center transform hover:scale-105 transition-all duration-300 cursor-pointer" style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 50%, #93c5fd 100%); box-shadow: 0 8px 12px -3px rgba(37, 99, 235, 0.12), 0 4px 6px -2px rgba(37, 99, 235, 0.06);">
            ...
            <div class="relative">
                ...
                <div class="text-2xl font-bold mb-1" style="color: #1d4ed8;"><?php echo e($inventory->total()); ?></div>
        ...
        <div class="group relative overflow-hidden rounded-xl p-4 text-center transform hover:scale-105 transition-all duration-300 cursor-pointer" style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 50%, #fcd34d 100%); box-shadow: 0 8px 12px -3px rgba(245, 158, 11, 0.1), 0 4px 6px -2px rgba(245, 158, 11, 0.05);">
            ...
            <div class="relative">
                ...
                <div class="text-2xl font-bold mb-1 text-yellow-700"><?php echo e($inventory->filter(fn($i) => $i->isLowStock())->count()); ?></div>
        ...
        <div class="group relative overflow-hidden rounded-xl p-4 text-center transform hover:scale-105 transition-all duration-300 cursor-pointer" style="background: linear-gradient(135deg, #fee2e2 0%, #fca5a5 50%, #f87171 100%); box-shadow: 0 8px 12px -3px rgba(239, 68, 68, 0.1), 0 4px 6px -2px rgba(239, 68, 68, 0.05);">
            ...
            <div class="relative">
                ...
                <div class="text-2xl font-bold mb-1 text-red-700"><?php echo e($inventory->filter(fn($i) => $i->isOutOfStock())->count()); ?></div>
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div class="flex flex-wrap gap-3 items-end flex-1">
            <div class="min-w-0 flex-1 lg:flex-initial">
                ...
                <input type="text" id="name-filter" name="name" class="form-input w-full" value="<?php echo e(request('name')); ?>" placeholder="Search items...">
            </div>
            <div class="min-w-0">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('staff.inventory.index')); ?>" class="btn btn-secondary">Reset</a>
            </div>
        </div>
        <a href="<?php echo e(route('staff.inventory.create')); ?>" class="btn btn-success flex items-center gap-2 px-4 py-2 whitespace-nowrap bg-blue-600 hover:bg-blue-700">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50/50 transition-colors border-b border-gray-100 last:border-b-0">
                        ...
                        <td class="py-3 px-4">
                            ...
                            ?>
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border <?php echo e($badge); ?>">
                                <i class="fas fa-circle mr-1 text-[6px]"></i> <?php echo e($label); ?>

                            </span>
                        </td>
                        <td class="py-3 px-4">
                            <a href="<?php echo e(route('staff.inventory.edit', $item->id)); ?>" class="inline-flex items-center gap-1 px-3 py-1.5 text-white text-xs font-medium rounded-md transition-colors bg-blue-600 hover:bg-blue-700">
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/staff/inventory/index.blade.php ENDPATH**/ ?>