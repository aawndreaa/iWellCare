...
<div class="flex justify-between items-center mb-8">
    ...
    <div class="flex space-x-3">
        <a href="<?php echo e(route('doctor.reports.monthly-sales')); ?>" class="btn-primary">
            <i class="fas fa-chart-line mr-2"></i>Monthly Sales
        </a>
        <a href="<?php echo e(route('doctor.reports.patient-report')); ?>" class="btn-secondary">
            <i class="fas fa-users mr-2"></i>Patient Report
        </a>
        <a href="<?php echo e(route('doctor.reports.consultation-report')); ?>" class="btn-secondary">
            <i class="fas fa-stethoscope mr-2"></i>Consultation Report
        </a>
        <a href="<?php echo e(route('doctor.reports.inventory-report')); ?>" class="btn-secondary">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views/doctor/reports/index.blade.php ENDPATH**/ ?>