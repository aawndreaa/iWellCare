...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-3xl font-bold text-gray-900">₱<?php echo e(number_format($inventory->sum(fn($i) => $i->quantity * $i->unit_price), 0)); ?></p>
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 mb-8">
        ...
        <form id="filterForm" method="GET" action="<?php echo e(route('admin.inventory.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="name" name="name" class="form-input w-full pl-10"
                           value="<?php echo e(request('name')); ?>" placeholder="Search by item name...">
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <select id="sort_by" name="sort_by" class="form-input w-full">
                    ...
                    <option value="quantity" <?php echo e(request('sort_by') === 'quantity' ? 'selected' : ''); ?>>Quantity</option>
                    <option value="unit_price" <?php echo e(request('sort_by') === 'unit_price' ? 'selected' : ''); ?>>Price</option>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3 mb-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-900">₱<?php echo e(number_format($item->unit_price, 0)); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-500">Total Value:</span>
                            <span class="font-semibold text-gray-900">₱<?php echo e(number_format($item->quantity * $item->unit_price, 0)); ?></span>
                        </div>
